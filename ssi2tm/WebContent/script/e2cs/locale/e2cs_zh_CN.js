...
e2cs.cal_locale={
	...
	daytitles:  ["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],
	todayLabel: '今天',
	todayToolTip: '设置今天日期...',
	...
	contextMenuLabelsDay: { 
		taskEdit: "编辑排班",						//0.0.7  tasks changed to events
		taskDelete: "删除排班", 					//0.0.7  tasks changed to events
		NextDay: "下一日", 
		PreviousDay: "上一日",
		chgwview: "切换至周视图...", 
		chgmview: "切换至月视图...",
